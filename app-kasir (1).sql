...
--
DELIMITER $$
CREATE TRIGGER `kurangiStok` AFTER INSERT ON `tbl_detailpenjualan` FOR EACH ROW UPDATE tbl_produk SET tbl_produk.stok = tbl_produk.stok - NEW.qty WHERE tbl_produk.id_produk = NEW.id_produk
$$
DELIMITER ;
DELIMITER $$
...
(16, 'PJLT016', '0000-00-00', 3, 7500),
(17, 'PJLT017', '0000-00-00', 3, 320000),
(18, 'PJLT018', '0000-00-00', 3, 70000),
(19, 'PJLT019', '0000-00-00', 3, 7500),
(20, 'PJLT020', '0000-00-00', 3, 60000),
(21, 'PJLT021', '0000-00-00', 3, 75000),
(22, 'PJLT022', '0000-00-00', 3, 7500),
(23, 'PJLT023', '0000-00-00', 3, 105000),
(24, 'PJLT024', '0000-00-00', 3, 85000),
(25, 'PJLT025', '0000-00-00', 3, 45000),
(26, 'PJLT026', '0000-00-00', 3, 45000),
(27, 'PJLT027', '0000-00-00', 3, 32500),
(28, 'PJLT028', '0000-00-00', 3, 32500),
(29, 'PJLT029', '0000-00-00', 3, 25000),
(30, 'PJLT030', '0000-00-00', 3, 7500),
(31, 'PJLT031', '0000-00-00', 3, 25000),
(32, 'PJLT032', '0000-00-00', 3, 55000),
(33, 'PJLT033', '0000-00-00', 3, 25000);
...
(20, 'PRD002', 'POP MIE', 5000, 7500, 10, 24, 0),
(21, 'PRD003', 'TEH KOTAK', 20000, 25000, 6, 28, 1),
(22, 'PRD004', 'TARO', 10000, 15000, 13, 29, 5),
(23, 'PRD005', 'bubur', 10000, 15000, 13, 24, 17);
