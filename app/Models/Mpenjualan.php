...
class Mpenjualan extends Model
{
    ...
    protected $allowedFields    = ['id_penjulan', 'no_faktur', 'tanggal_penjualan', 'waktu', 'grand_total', 'id_pengguna'];
    ...
    public function getPenjualan(){
        ...
        $produk->join('tbl_pengguna', 'tbl_pengguna.id_pengguna=tbl=penjualan.id_pengguna', 'LEFT');
