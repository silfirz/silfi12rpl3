...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/logo8.png" rel="icon">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">KasirSilfi</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="<?= site_url('proses-login');?>" method="post">
              ...
              <div class="credits">
                ...
                Designed by <a href="https://bootstrapmade.com/">Kasir Silfi</a>
              </div>
